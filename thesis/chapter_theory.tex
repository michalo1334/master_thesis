...
Diagrams are drawn with TikZ inside a \texttt{figure} environment. The example below is a small attack graph: each node is a host, and arrows show exploit opportunities. TikZ is sensitive to coordinate placement, so it is worth sketching the layout before committing to code.
