...
A comprehensive evaluation framework for assessing Agent Skill quality against official specifications and best
practices. This skill provides multi-dimensional scoring and actionable improvement suggestions for SKILL.md files and
skill packages.
...
The skill helps you evaluate whether a Skill actually adds value by measuring its "knowledge delta" - the gap between
what the Skill provides and what Claude already knows. A good Skill should be a compressed expert brain, not a tutorial.
...
- **Tool vs Skill**: Tools define capability boundaries (what Claude CAN do). Skills inject knowledge (what Claude KNOWS
  how to do).
