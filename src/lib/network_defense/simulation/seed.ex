defmodule NetworkDefense.Simulation.Seed do
  ...
  """
  @spec random() :: integer()
  def random, do: :crypto.strong_rand_bytes(8) |> :binary.decode_unsigned()
  ...
  """
  @spec integer_to_state(integer()) :: :rand.seed(:rand.seed_s())
  ...
  """
  @spec seed_state(integer() | :rand.seed(:rand.seed_s())) :: :rand.seed(:rand.seed_s())
