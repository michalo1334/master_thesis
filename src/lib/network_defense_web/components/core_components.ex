defmodule NetworkDefenseWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: NetworkDefenseWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NetworkDefenseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NetworkDefenseWeb.Gettext, "errors", msg, opts)
    end
  end
